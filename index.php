...
<body>
  <div class="container">
    <div class="header">
      <img src="img\robot.png" alt="Chatbot Logo">
      <h1> <span style="color: skyblue;padding-right: 1rem;"> Chatbot! </span><small> ASK WHATEVER</SMALL></h1>
    </div>
    <div class="chat-box">
      <div class="messages">
        <?php
        ...
        ?>
            <div class="message sent">
              <div class="avatar"><img src="img\boy.png" alt="User Avatar"></div>
              <div class="text"><?= $row["message_send"] ?></div>
              <div class="time"><?= $row["send_date"] ?></div>
            </div>
            <div class="message received">
              <div class="avatar"><img src="img/robot.png" alt="User Avatar"></div>
